...
public:
    ...
    // CUSTOM CODE
    std::vector<std::vector<int>> polyFaces;        // The ordered indices of the faces that make up the polygons
    std::vector<std::vector<int>> openPolyFaces;    // The ordered indices of the faces that make up the open poly-lines
    // END CUSTOM CODE

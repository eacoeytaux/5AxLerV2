...
class PrintTimeMaterialEstimates : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cura.proto.PrintTimeMaterialEstimates) */ {
 public:
  ...
  static const int kMaterialEstimatesFieldNumber = 2;
...
// optional float time = 1;
inline void PrintTimeMaterialEstimates::clear_time() {
  time_ = 0;
}
inline float PrintTimeMaterialEstimates::time() const {
  // @@protoc_insertion_point(field_get:cura.proto.PrintTimeMaterialEstimates.time)
  return time_;
}
inline void PrintTimeMaterialEstimates::set_time(float value) {

...
namespace cura
{
    ...
    bool FffPolygonGenerator::sliceModel(MeshGroup* meshgroup, TimeKeeper& timeKeeper, SliceDataStorage& storage) /// slices the model
    {
        ...
        int initial_slice_z = 5;//initial_layer_thickness - layer_thickness / 2;
...
//            node.orientMesh();
            ...
            viewerfile << "../../Slicer/" << filename << " " << bestVector.x << " " << bestVector.y << " " << bestVector.z << "\n";
        }
